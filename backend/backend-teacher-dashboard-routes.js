...
// Simple auth middleware for teacher routes (temporarily disabled for testing)
const authenticateTeacher = (req, res, next) => {
  // Temporarily skip authentication for testing
  console.log('API call received:', req.method, req.path);
  next();
  
  /* Enable this later for proper authentication
...
// =====================================================
// GET /api/teacher-dashboard/attendance/classes
// Get teacher's classes for attendance management
// =====================================================
router.get('/attendance/classes', authenticateTeacher, async (req, res) => {
  try {
    // Mock data for teacher's classes (specific to attendance management)
    const mockClasses = [
      {
        id: '1',
        class: 'Grade 10-A',
